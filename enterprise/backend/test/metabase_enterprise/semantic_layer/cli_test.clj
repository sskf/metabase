(ns metabase-enterprise.semantic-layer.cli-test
  (:require
   [clojure.edn :as edn]
   [clojure.test :refer :all]
   [metabase-enterprise.semantic-layer.cli :as cli]
...
(def ^:private fixture-1-dir
  "enterprise/backend/test_resources/semantic_layer/complexity_fixture_1")
