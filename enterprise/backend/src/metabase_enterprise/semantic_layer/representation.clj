(ns metabase-enterprise.semantic-layer.representation
  ...
  [[metabase-enterprise.semantic-layer.complexity]]: it produces library + universe catalog maps
...
(defn load-dir
  ...
  [[metabase-enterprise.semantic-layer.complexity/score-from-entities]].
