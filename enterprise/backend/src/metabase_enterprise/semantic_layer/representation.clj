(ns metabase-enterprise.semantic-layer.representation
  ...
  [[metabase-enterprise.semantic-layer.complexity]]: it produces library + universe entity vectors
...
(defn load-dir
  ...
  shaped for [[metabase-enterprise.semantic-layer.complexity/score-from-entities]].
