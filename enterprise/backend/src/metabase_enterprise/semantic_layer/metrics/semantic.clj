(ns metabase-enterprise.semantic-layer.metrics.semantic
  "Semantic-disambiguation dimension — meaning-level overlap computed from embedded name vectors.
   ...
   calibrated in `test_resources/semantic_layer/analysis/2026_04_21_data_analysis_summary.md`) and
   ...
   All tier 2."
  (:require
   [metabase-enterprise.semantic-layer.metrics.common :as common]
